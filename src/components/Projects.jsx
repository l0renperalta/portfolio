...
const Projects = () => {
  ...
  return (
    <div className="w-[100%] bg-white dark:bg-primary dark:text-white" id="projects">
      ...
      <div className="w-[95%] md:w-[70%] mx-auto pb-20 md:pb-48 flex flex-col items-center justify-center">
        <h1 className="text-3xl mb-16 font-bold text-center md:text-4xl">PROJECTS</h1>
        <div className="grid grid-cols-1 md:grid-cols-2">
          <div className="m-6 p-6 rounded-xl bg-zinc-200 dark:bg-zinc-800 dark:text-white">
            ...
            <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">View Code</button>
          </div>
          <div className="m-6 p-6 rounded-xl bg-zinc-200 dark:bg-zinc-800 dark:text-white">
            <h3 className="font-bold text-lg">Uber clone</h3>
          ...
          <div className="m-6 p-6 rounded-xl bg-zinc-200 dark:bg-zinc-800 dark:text-white">
            <h3 className="font-bold text-lg">multi-language site</h3>
